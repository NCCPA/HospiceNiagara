...
{
    public class FolderGroupPrivacy
    {
             public FolderGroupPrivacy()
            {
                this.Role = new HashSet<Role>();
                this.ApplicationUser = new HashSet<ApplicationUser>();
                this.SubRole = new HashSet<SubRole>();
                this.FolderGroup = new HashSet<FolderGroup>();
            }
            ...
            public virtual ICollection<FolderGroup> FolderGroup { get; set; }
    }
}